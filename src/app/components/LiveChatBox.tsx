    ...
    <>
      {isOpen ? (
        ...
        <div className="p-6">
          ...
          {/* Expert Team (Telegram) */}
          <button
            onClick={handleTelegram}
            className="w-full bg-[#0088cc] hover:bg-[#0077b5] text-white p-4 rounded-lg mb-3 flex items-center gap-3 transition-colors group"
          >
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white p-4 rounded-lg flex items-center gap-3 transition-colors group"
          >
            <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center">
              <MessageCircle size={24} className="text-white" />
            </div>
            <div className="text-left flex-1">
              <div className="font-bold text-lg">Steadfast online CS</div>
              <div className="text-sm text-white/90">Live chat with support</div>
            </div>
            <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
