  ...
  if (loading) {
    return (
      <div className="size-full overflow-auto pb-20 bg-[#1a1f2e]">
        ...
        {/* Skeleton ticker bar */}
        <div className="relative overflow-hidden bg-[linear-gradient(90deg,#04182e_0%,#072240_50%,#04182e_100%)] border-y border-[#00D9FF]/10 py-2.5">
          <div className="flex items-center gap-6 px-4 animate-pulse">
            <div className="flex items-center gap-1.5 bg-[#00D9FF]/5 border border-[#00D9FF]/20 rounded-full px-2.5 py-1">
              <span className="relative flex h-2 w-2"><span className="inline-flex rounded-full h-2 w-2 bg-gray-600" /></span>
              <span className="text-[10px] font-bold tracking-widest text-gray-500 uppercase">Live</span>
            </div>
            <div className="h-3 w-48 bg-[#1a2a44] rounded" />
            <div className="h-3 w-32 bg-[#1a2a44] rounded hidden sm:block" />
          </div>
        </div>
        ...
        <div className="max-w-2xl mx-auto px-6 py-6 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="animate-pulse">
              <div className="h-3.5 w-12 bg-[#293149] rounded mb-2" />
              <div className="h-7 w-36 bg-[#2f3851] rounded" />
            </div>
            <div className="animate-pulse h-9 w-20 bg-gradient-to-r from-[#3d3020] to-[#3a2d18] rounded-full" />
          </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm animate-pulse">
            ...
            <div className="text-center">
              <div className="h-4 w-48 bg-gray-200 rounded mx-auto mb-3" />
          ...
          {/* Task submission card skeleton */}
          <div className="bg-gradient-to-br from-[#252d42] to-[#1a1f2e] border border-[#00D9FF]/15 rounded-xl overflow-hidden animate-pulse">
            <div className="flex items-center gap-4 p-4 bg-white/5">
              <div className="w-20 h-20 bg-[#31415f] rounded-lg shrink-0" />
              <div className="flex-1">
                <div className="h-2.5 w-24 bg-[#00D9FF]/15 rounded mb-2" />
                <div className="h-4 w-40 bg-[#31415f] rounded mb-2" />
                <div className="h-2.5 w-28 bg-[#31415f] rounded" />
              </div>
            </div>
            <div className="flex items-center justify-between px-4 py-3 bg-emerald-800/40">
              <div>
                <div className="h-2.5 w-24 bg-emerald-600/40 rounded mb-1.5" />
                <div className="h-5 w-12 bg-emerald-600/40 rounded" />
              </div>
              <div className="text-right">
                <div className="h-2.5 w-24 bg-emerald-600/40 rounded mb-1.5" />
                <div className="h-6 w-16 bg-emerald-600/40 rounded" />
              </div>
            </div>
            <div className="px-4 py-2.5 flex items-center justify-between">
              <div className="h-2.5 w-28 bg-[#31415f] rounded" />
              <div className="h-2.5 w-28 bg-[#3d3528] rounded" />
            </div>
          </div>

          {/* Submit button skeleton */}
          <div className="h-14 w-full bg-[#00D9FF]/15 rounded-xl animate-pulse" />

          {/* Financial panel skeleton */}
          <div className="relative overflow-hidden rounded-[22px] bg-[linear-gradient(145deg,#0b5ab5_0%,#0a6fcc_52%,#128cb8_100%)] text-white/30 shadow-lg">
            <div className="p-4 md:p-5 animate-pulse">
              <div className="text-center">
                <div className="h-5 w-32 bg-white/10 rounded-full mx-auto mb-3" />
                <div className="rounded-[18px] border border-white/10 bg-white/5 p-4 mb-4">
                  <div className="h-6 w-6 bg-white/10 rounded mx-auto mb-2" />
                  <div className="h-2.5 w-32 bg-white/10 rounded mx-auto mb-3" />
                  <div className="h-8 w-36 bg-white/10 rounded mx-auto mb-2" />
                  <div className="h-2.5 w-52 bg-white/10 rounded mx-auto" />
                </div>
              </div>
              ...
              <div className="mt-3 rounded-[18px] border border-white/10 bg-white/5 p-4 text-center">
                <div className="h-2.5 w-36 bg-white/10 rounded mx-auto mb-2" />
                <div className="h-7 w-36 bg-white/10 rounded mx-auto mb-2" />
                <div className="h-2.5 w-48 bg-white/10 rounded mx-auto" />
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center gap-2 py-2">
            <Loader2 className="animate-spin text-[#00D9FF]/60" size={16} />
